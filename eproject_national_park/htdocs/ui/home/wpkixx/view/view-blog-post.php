                     ...
                     <div class="col-md-8">
                        ...
                        <div class="blog-single">
                                    <ul class="share-links">
                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u=http://www.myprojecttest.tk/blog-post.php?post_id={$result['post_id']}" title="" class="facebook"><i class="fa fa-facebook"></i><span>Share on Facebook</span></a></li>
...
?> </li>
                                            <li><i class="fa fa-comments-o"></i><?php echo $comment_total ? $comment_total. ' Bình luận' : 'Chưa có bình luận nào';?></li>
                                        </ul>
                                    </div>
                         ...
                         <!--     <div class="widget-title">
							  ...
							  <div class="widget-title"> 
                                        ...
                                        <div class="subscribe-us">
                                            ...
                                            <span>Hãy đăng kí nhận tin từ chúng tôi để luôn cập nhật với tin tức hằng ngày.(đang cập nhật)</span>
